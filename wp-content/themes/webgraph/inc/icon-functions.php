 ...
 */
function webgraph_include_svg_icons() {
...
add_action( 'wp_footer', 'webgraph_include_svg_icons', 9999 );
 ...
 */
function webgraph_get_svg( $args = array() ) {
	// Make sure $args are an array.
	if ( empty( $args ) ) {
		return __( 'Please define default parameters in the form of an array.', 'webgraph' );
	}

	// Define an icon.
	if ( false === array_key_exists( 'icon', $args ) ) {
		return __( 'Please define an SVG icon filename.', 'webgraph' );
	}
